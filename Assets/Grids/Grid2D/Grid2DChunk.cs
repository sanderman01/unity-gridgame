...
namespace AmarokGames.Grids {
    ...
    public class Grid2DChunk : MonoBehaviour {
        ...
        public Rect CalculateChunkAABB() {
            ...
            Vector2 p2 = m * new Vector2(0, Grid2D.ChunkHeight);
            Vector2 p3 = m * new Vector2(Grid2D.ChunkWidth, Grid2D.ChunkHeight);
            Vector2 p4 = m * new Vector2(Grid2D.ChunkWidth, 0);
